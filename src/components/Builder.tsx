...
import { AOMessageSigner, type AOMessageSignerProps } from "./AOMessageSigner"
  ...
  const renderComponent = () => {
    switch (component.type) {
      ...
      case 'AOMessageSigner':
        return <AOMessageSigner {...(component.props as AOMessageSignerProps)} />;
      case 'ChatBot':
        return <ChatBot {...component.props} />;
      default:
        ...
        return (
          <>
            <div className="space-y-2">
              ...
              <input
                type="text"
                value={component.props.processId || ''}
                onChange={(e) => onPropertyChange('processId', e.target.value)}
                className="w-full p-2 border rounded-md"
              />
            </div>
            <div className="space-y-2">
              ...
              <select
                ...
                onChange={(e) => onPropertyChange('theme', e.target.value)}
              >
